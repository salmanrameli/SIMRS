        ...
        <div class="row">
            <div class="card card-body">
                ...
                @if(Auth::user()->jabatan_id == 2)
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{ route('ranap.pasien.create') }}" class="btn btn-outline-primary btn-sm btn-block" style="margin-top: 10px; margin-bottom: 10px">Daftarkan Pasien Baru</a>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('ranap.pasien.index') }}" class="btn btn-outline-info btn-sm btn-block" style="margin-bottom: 10px">Lihat Semua Pasien</a>
                        </div>
                    </div>
                    <div style="padding-bottom: 15px"></div>
                @endif
