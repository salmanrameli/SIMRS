<div class="d-lg-none">
    <nav class="navbar navbar-light bg-light" style="margin-bottom: 20px; border-bottom: solid 1px darkgray">
        <a class="navbar-brand" href="/"><img src="{{ asset('/storage/logo.jpg') }}" width="35" height="35" alt="logo"><small style="font-size: 12px;"> @ {{ Auth::user()->nama }} – {{ $jabatan }}</small></a>
...
<div class="d-none d-lg-block" style="padding-bottom: 80px">
    <nav class="navbar navbar-light bg-white fixed-top"  style="margin-bottom: 20px; border-bottom: 1px solid darkgray;">
        <a class="navbar-brand" href="/"><img src="{{ asset('/storage/logo.jpg') }}" width="35" height="35" alt="logo"> | <small style="font-size: 14px">{{ Auth::user()->nama }} – {{ $jabatan }}</small></a>
