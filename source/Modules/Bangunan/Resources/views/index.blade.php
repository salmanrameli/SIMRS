...
@section('content-mobile')
                ...
                <div class="card-header">
                    <h5>
                        ...
                        @if(Auth::user()->jabatan_id == 1)
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button type="button" class="btn btn-sm btn-warning btn-block" data-toggle="modal" data-id-lantai="{{ $lantai->id }}" data-nomor="{{ $lantai->nomor_lantai }}" data-target="#modalUbahLantaiMobile">Ubah</button>
                                </div>
                                <div class="col-6">
                                    {{ Form::open(['method' => 'delete', 'route' => ['lantai.delete', $lantai->id]]) }}
                                    <button type="submit" class="btn btn-sm btn-danger btn-block" onclick="return confirm('Apakah anda yakin menghapus lantai ini?')">Hapus</button>
                                    {{ Form::close() }}
                                </div>
                            </div>
                        @endif
                                ...
                                @if($lantai->nomor_lantai == $kamar->nomor_lantai)
                                    <div class="col-md-2">
                                        <div class="card card-body">
                                            ...
                                            @if(Auth::user()->jabatan_id == 1)
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-id-kamar="{{ $kamar->id }}" data-nama-kamar="{{ $kamar->nama_kamar }}" data-jumlah-maks="{{ $kamar->jumlah_maks_pasien }}" data-target="#modalUbahKamarMobile" style="width: 100%">Ubah</button>
                                                    <button type="button" class="btn btn-warning dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <span class="sr-only">Toggle Dropdown</span>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-right">
    ...
    <div class="modal fade" id="modalTambahLantaiMobile" tabindex="-1" role="dialog" aria-labelledby="modalTambahLantaiMobile" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahLantaiMobile">Tambah Lantai Baru</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalUbahLantaiMobile" tabindex="-1" role="dialog" aria-labelledby="modalUbahLantaiMobile" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUbahLantaiMobile">Ubah Nomor Lantai</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalTambahKamarMobile" tabindex="-1" role="dialog" aria-labelledby="modalTambahKamarMobile" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahKamarMobile">Tambah Kamar Baru</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalUbahKamarMobile" tabindex="-1" role="dialog" aria-labelledby="modalUbahKamarMobile" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUbahKamarMobile">Ubah Rincian Kamar</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@section('script')
    <script>
        $(function() {
            ...
            $('#modalUbahLantaiMobile').on("show.bs.modal", function (e) {
                $("#modalUbahLantaiMobile").find('#id_lantai').val($(e.relatedTarget).data('id-lantai'));
                $("#modalUbahLantaiMobile").find('#nomor_lantai').val($(e.relatedTarget).data('nomor'));
            });

            $('#modalTambahKamarMobile').on("show.bs.modal", function (e) {
                $("#modalTambahKamarMobile").find('#nomor_lantai').val($(e.relatedTarget).data('nomor'));
                $("#modalTambahKamarMobile").find('#nama_kamar').val('');
                $("#modalTambahKamarMobile").find('#jumlah_maks_pasien').val('');
            });

            $('#modalUbahKamarMobile').on("show.bs.modal", function (e) {
                $("#modalUbahKamarMobile").find('#id_kamar').val($(e.relatedTarget).data('id-kamar'));
                $("#modalUbahKamarMobile").find('#nama_kamar').val($(e.relatedTarget).data('nama-kamar'));
                $("#modalUbahKamarMobile").find('#jumlah_maks_pasien').val($(e.relatedTarget).data('jumlah-maks'));
            });
        });
    </script>
